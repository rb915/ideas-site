...
def main():
    ...
    # Group by theme (skip Breaking News and Origin Stories items — they get their own sections)
...
{fs_items_joined}
    ...
    # ---- Combine: Breaking News at top, then Origin Stories, then Format Segments, then themed sections ----
